...
#            v["tirelf"]=o.get_diagnostics().results[0].reportData.metrics.tirePressureLf
#            v["tirelr"]=o.get_diagnostics().results[0].reportData.metrics.tirePressureLr
#            v["tirerf"]=o.get_diagnostics().results[0].reportData.metrics.tirePressureRf
#            v["tirerr"]=o.get_diagnostics().results[0].reportData.metrics.tirePressureRr
#            v["tirestatuslf"]=o.get_diagnostics().results[0].reportData.metrics.tireStatusLf=="GREEN"
#            v["tirestatuslr"]=o.get_diagnostics().results[0].reportData.metrics.tireStatusLr=="GREEN"
#            v["tirestatusrf"]=o.get_diagnostics().results[0].reportData.metrics.tireStatusRf=="GREEN"
#            v["tirestatusrr"]=o.get_diagnostics().results[0].reportData.metrics.tireStatusRr=="GREEN"
#            v["nextmainodo"]=o.get_diagnostics().results[0].reportData.maintenance.nextMaintDate
#            v["nextmainodo"]=o.get_diagnostics().results[0].reportData.maintenance.nextMaintOdometer
#            v["airbagok"]=o.get_diagnostics().results[0].reportData.sections.airbag.status=="GREEN"
